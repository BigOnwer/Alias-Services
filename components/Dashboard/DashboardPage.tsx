        ...
        <div>
            ...
            <main className="flex flex-col items-center mt-6 w-full">
                <div className="flex flex-wrap justify-around w-full mb-6">
                    <div>
                        <Card title="Remuneration" value="R$45.000,89" description="+20.1% from last month" icon={DollarSign} color="text-lime-600"/>
                        <PieChart value={2.01}/>
                    </div>
                    <div>
                    ...
                    <div>
                        <Card title="Saidas" value="R$-5.040,72" description="-15.8% from last month" icon={DollarSign} color="text-red-600"/>
                        <PieChart value={1.58}/>
                    </div>
                </div>
